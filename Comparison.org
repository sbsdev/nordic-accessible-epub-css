...
:END:
**** SBS
#+begin_src css :tangle /tmp/sbs_table_font.css :eval no
  * {
...
**** MTM
#+begin_src css :tangle /tmp/mtm_table_font.css :eval no
body {
...
**** Guidelines
#+begin_src css :tangle /tmp/guidelines_table_font.css :eval no
  /* not defined */
#+end_src
...
#+RESULTS:
#+begin_src diff
--- /tmp/mtm_table_font.css	2025-03-27 13:07:41.717532809 +0100
+++ /tmp/guidelines_table_font.css	2025-03-27 13:07:41.717532809 +0100
@@ -1,3 +1 @@
-body {
-    font-family: arial, helvetica, verdana, sans-serif;
-}
